...
Section "Vanilla Soulstorm Hotkeys" SecA
...
Section "Left-Handed Hotkeys" SecD
...
Section "Stronghold Assaults minimod" SecE

 SetOutPath "$PROGRAMFILES\Steam\steamapps\common\Dawn of War Soulstorm"
 File /r ".\Content\SectionE\*.*"
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecA ${LANG_ENGLISH} "Installs the Vanilla Soulstorm hotkeys adapted to the mod."
  LangString DESC_SecB ${LANG_ENGLISH} "Installs the AZERTY hotkeys adapted to the mod."
  LangString DESC_SecC ${LANG_ENGLISH} "Installs the QWERT hotkeys adapted to the mod."
  LangString DESC_SecD ${LANG_ENGLISH} "Installs the left-handed hotkeys to the mod."
  LangString DESC_SecE ${LANG_ENGLISH} "Installs the Stronghold Assaults minimod in your main Soulstorm folder. NOTE: AFTER INSTALLING IT, GO TO THE GAME MANAGER AND ACTIVATE IT."
